...
public:
    void rotate(vector<vector<int>>& matrix) {
        ...
        // The rotation is decomposed into two steps:
        
        // Step 1: Transpose the matrix.
        // This is equivalent to a 90-degree counter-clockwise rotation.
        transpose(matrix);

        // Step 2: Reverse each row.
        // This reverses the order of columns, completing the 90-degree clockwise rotation.
        reverseRows(matrix);
    }
};
